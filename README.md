...
즉, commit과 rollback을 사용하면 바로 이전 commit까지 데이터를 복구하지만 savepoint는 지정한 c1값까지 데이터를 복구한다.

rollback to savepoint c1을 사용한다.
...
## oracle과 mysql 차이점
![image](https://github.com/hsy0511/oracle-foundation/assets/104752580/79c23921-a73a-44be-b0de-ba9c024989b5)
###### ※ 스토리지: 대용량 데이터 저장장치
###### ※ 중첩 루프 조인:  N 개의 집합을 N 개의 중첩된 반복문을 사용해 조인
###### ※ 해시 조인: 관계형 데이터베이스 관리 시스템의 구현
###### ※ 소트 머지 조인: 조회의 범위가 많을 때 사용하는 조인
